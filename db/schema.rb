...
ActiveRecord::Schema[7.1].define(version: 2025_05_05_133502) do
  ...
  create_table "applied_events", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "preset_id", null: false
    t.bigint "user_id", null: false
    t.date "date", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["preset_id"], name: "index_applied_events_on_preset_id"
    t.index ["user_id"], name: "index_applied_events_on_user_id"
  end
  ...
  create_table "preset_events", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["preset_id"], name: "index_preset_events_on_preset_id"
  end

  create_table "presets", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "applied_events", "presets"
